...
public class PEditTextView extends ViewGroup {
    ...
    public PEditTextView(Context context, AttributeSet attrs) {
        ...
        round = typedArray.getDimension(R.styleable.PEditTextView_round, 5 * density);
...
//            }
            canvas.drawRoundRect(rectF, round, round, _paint);
...
//                canvas.drawCircle(rectF.centerX(), rectF.centerY(), boxWandH / 5, _paint);
                ...
                canvas.drawText("*", rectF.centerX() - widths[0] / 2 , rectF.centerY() + widths[0] , _paint);
            } else {
                _paint.clearShadowLayer();
